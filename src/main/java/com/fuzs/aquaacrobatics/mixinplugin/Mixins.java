...
public enum Mixins {
    ...
    public static List<String> getEarlyMixins(Set<String> loadedCoreMods) {
        ...
        AquaAcrobaticsCore.LOGGER.info("Not loading the following EARLY mixins: {}", notLoading);
        return mixins;
    }
    ...
    public static List<String> getLateMixins(Set<String> loadedMods) {
        ...
        AquaAcrobaticsCore.LOGGER.info("Not loading the following LATE mixins: {}", notLoading.toString());
        return mixins;
    }
